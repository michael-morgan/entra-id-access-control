...
namespace Api.Modules.AccessControl.Persistence.Migrations.Authorization
{
    ...
    [Migration("20251203024954_AddGroupAndRoleAttributes")]
    partial class AddGroupAndRoleAttributes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AccessControl.Framework.SqlServer.Entities.Authorization.GroupAttribute", b =>
                {
                    ...
                    b.HasIndex("GroupId")
                        .IsUnique()
                        .HasDatabaseName("IX_GroupAttributes_GroupId");
            ...
            modelBuilder.Entity("AccessControl.Framework.SqlServer.Entities.Authorization.RoleAttribute", b =>
                {
                    ...
                    b.HasIndex("AppRoleId")
                        .IsUnique()
                        .HasDatabaseName("IX_RoleAttributes_AppRoleId");

                    b.HasIndex("RoleValue")
                        .HasDatabaseName("IX_RoleAttributes_RoleValue");
